...
<div id="wrapper">
    ...
    <div class=" card justify-content-center" style="width: 100%; padding-left: 55px">
        <div class="row">
            <div class="col">
                <h5>You have arrived here on error. Please click on <a href="${pageContext.request.contextPath}/home">home</a> to return to home page.</h5>
